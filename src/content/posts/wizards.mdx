...
date: 2024-07-10
description: How we built multi-step forms in Rails, with insights on best practices, common gems, and a reusable, session-based pattern. Perfect for GOV.UK-style services.
---
